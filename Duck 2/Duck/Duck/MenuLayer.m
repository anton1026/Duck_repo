...

{
    ...
    if (x>0 && x<150 && y>650){
        ...
        [[CCDirector sharedDirector] replaceScene:[CCTransitionShrinkGrow transitionWithDuration:0.5 scene:SetupLayer.scene]];

    
    }else if (x > 225 && x < 770 && y > 500 && y < 650){
        // Tutorial
        [[SimpleAudioEngine sharedEngine] stopBackgroundMusic];
        [[CCDirector sharedDirector] replaceScene:[CCTransitionShrinkGrow transitionWithDuration:0.5 scene:TutorialLevel.scene]];
