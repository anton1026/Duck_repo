...
//---------------------------------------------------------------------------------------
  ...
  //---------------------test---------------
        ...
        [m_shootSprite2 setVisible:true];
		...
		// init birds
        [[m_Birds alloc] initWithNode:m_rootNode];
        [[m_Orel  alloc] initWithNode:m_rootNode];
		[m_Birds InitBirds];
		[m_Orel initOrel];
...
-(void) updateBombs :(float) dt
{
    ...
    long curTicks =[[NSDate date] timeIntervalSince1970]*1000;//SystemClock.uptimeMillis();
                 ...
                 if ([bb.bonus_live.action isDone]) {
                     ...
                     if (curTicks > m_BonusTime){
                      ...
                      if ([bb.bonus_shoot.action isDone]) {
                          ...
                          {
                          //       m_LiveTime = [[NSDate date] timeIntervalSince1970]*1000 + m_CurLevel.m_MinDelayLives                                 + random.nextInt(m_CurLevel.m_MaxAddDelayLives);
                          }
